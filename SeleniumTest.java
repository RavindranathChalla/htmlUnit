...
public class SeleniumTest {
  ...
  public static void main(String[] args) {
    ...
    // headerText.clear();
    actions.moveToElement(headerText);
    actions.click();

    actions.sendKeys("SOME DATA");
    actions.build().perform();
    System.out
        .println("After change-->" + driver.findElement(By.xpath("/html/body/h1[1]")).getText());

    /*
     * WebElement button = driver.findElement(By.xpath("/html/body/div/button[4]"));
     * System.out.println("Buton Text-->" + button.getText()); button.click();
     */
    JavascriptExecutor js = (JavascriptExecutor) driver;
    js.executeScript("var h = document.createElement('H1');"
        + "var t = document.createTextNode('Ravi Entered Test');" + "h.appendChild(t);"
